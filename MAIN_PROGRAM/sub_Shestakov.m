function [r,z] = sub_Shestakov(nc,a)
% This subroutine generates highly distorted meshes using Shestakov’s algorithm  
% for a rectangular domain. This function is called in Pre_GenerateDiscratization.m 
% when discretization method ‘D’ is used.
